    ...
    const removeFileFromSet = useCallback(
      async (i: number) => {
        ...
        if (fileToRemove) {
          ...
          try {
            if(fileToRemove.dto) await ***REMOVED***Client.delete(fileToRemove.dto); // TODO: in case user last seconds cancels record save AFTER attachment removal it may cause problems that attachments are still attached to the record but not existient on the storage
          } catch (error) {
