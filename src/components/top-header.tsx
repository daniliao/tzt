            ...
            <CommandDialog open={commandDialogOpen} onOpenChange={setCommandDialogOpen}>
              <CommandInput className="cursor-pointer text-sm" placeholder="Type a command or search..." />
                <CommandList>
                  ...
                  <CommandItem ***REMOVED***="cmd-edit-folder" className="cursor-pointer text-xs"  onSelect={(e) => { recordContext?.setRecordEditMode(true); }}><PlusIcon /> Add health record</CommandItem>
