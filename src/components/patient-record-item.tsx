...
export default function PatientRecordItem(record: PatientRecord) {
  ...
  const sendHealthReacordToChat = async (record: PatientRecord) => {
    ...
    chatContext.sendMessage({
      role: 'user',
      createdAt: new Date(),
      content: 'This is my health result data. Please parse it to JSON. Include the type of this data in "type" ***REMOVED*** of JSON. As a separate message please describe the results in plain language markdown.',
