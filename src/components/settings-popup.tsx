...
export function SettingsPopup() {
  ...
  useEffect(() => {
    ...
    if(config?.dbStatus.status === DBStatus.AuthorizationError) {
      toast("Authorization error", { description: "Invalid encryption ***REMOVED***. Please try again with different ***REMOVED*** or create a new database",  duration: 2000, action: { label: 'Create new DB', onClick: () => askBeforeCreateNewDB() }});
    }
  },[config?.dbStatus])   
