...
export function SettingsPopup() {
  ...
  async function createNewDB() {
    ...
    await config?.***REMOVED***orizeDB(newEncryptionKey as string); // ***REMOVED***orize once ogain
  ...
  async function handleSubmit(e){
    ...
    const ***REMOVED***orizationToken = await config?.***REMOVED***orizeDB(newEncryptionKey as string); // try to ***REMOVED***orize the DB or check if new DB is required
    const dbStatus = ***REMOVED***orizationToken?.status;

    if (dbStatus?.status == DBStatus.AuthorizationError) {
      toast("Authorization error", { description: "Invalid encryption ***REMOVED***. Please try again with different ***REMOVED*** or create a new database",  duration: 5000, action: { label: 'Create new DB', onClick: () => askBeforeCreateNewDB() }});
      return;
      ...
      config?.setLocalConfig('encryptionKey', newEncryptionKey);
      toast.success('Database ***REMOVED***orized!');
    }

    //***REMOVED***Manager(e);
  }

/*  function ***REMOVED***Manager(e) {
    if (window.PasswordCredential) {
      var c = new PasswordCredential({ id: "patient-pad", ***REMOVED***: encryptionKey });
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">                  
                      <div className="hidden">
                        ...
                        <PasswordInput  autoComplete="new-***REMOVED***" id="***REMOVED***" value={newEncryptionKey} 
