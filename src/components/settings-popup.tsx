              ...
              <div className="grid gap-1">
                ...
                <div class="hidden">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Please save or print this master ***REMOVED***. <strong>It's like crypto wallet.</strong> After losing it your medical records <strong class="text-red-500">WILL BE LOST FOREVER</strong>.
