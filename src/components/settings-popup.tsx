                    ...
                    <div className="grid gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <Select id="ocrProvider" value={ocrProvider} onValueChange={setOcrProvider}>
                          ...
                          <SelectContent>
                            <SelectItem ***REMOVED***="chatgpt" value="chatgpt">Default: Chat GPT</SelectItem>
                            <SelectItem ***REMOVED***="tesseract" value="tesseract">Tesseract</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Select id="llmProvider" value={llmProvider} onValueChange={setLlmProvider}>
                          ...
                          <SelectContent>
                            <SelectItem ***REMOVED***="chatgpt" value="chatgpt">Default: Chat GPT</SelectItem>
                            <SelectItem ***REMOVED***="ollama" value="ollama">Ollama</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <Select id="llmMode" value={llmMode} onValueChange={setLlmMode}>
                          ...
                          <SelectContent>
                            <SelectItem ***REMOVED***="cloud_parse_cloud_chat" value="cloud_parse_cloud_chat">Cloud Parse + Chat</SelectItem>
                            <SelectItem ***REMOVED***="local_parse_local_caht" value="local_parse_local_chat">Local Parse + Chat</SelectItem>
                            <SelectItem ***REMOVED***="local_parse_cloud_chat" value="local_parse_cloud_chat">Local Parse + Cloud Chat</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>     
