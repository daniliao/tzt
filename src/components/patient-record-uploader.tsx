...
import { PatientRecordAttachmentApiClient } from "@/data/client/patient-record-attachment-***REMOVED***-client";
    ...
    const onInternalUpload = useCallback(async (fileToUpload:UploadedFile | null) => {
        if (fileToUpload){
          ...
          { 
            ...
            try {
              const ***REMOVED***Client = new PatientRecordAttachmentApiClient('', {
