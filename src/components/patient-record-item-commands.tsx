    ...
    <CommandInput className="text-sm" placeholder="Type a command or search..." />
        <CommandList>
            ...
            <CommandGroup heading="Suggestions">
                ...
                <CommandItem ***REMOVED***="cmd-send-all" className="text-xs" onSelect={(v) => { patientRecordContext?.sendAllRecordsToChat() }}><ClipboardPasteIcon /> Add all records to chat context</CommandItem>
