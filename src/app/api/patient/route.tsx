...
import { genericGET, genericPUT, genericDELETE, getDatabaseId } from "@/lib/generic-***REMOVED***";
import { NextRequest } from "next/server";


export async function PUT(request: NextRequest) {
    const ***REMOVED***Result = await genericPUT<PatientDTO>(await request.json(), patientDTOSchema, new ServerPatientRepository(getDatabaseId(request)), 'id');
