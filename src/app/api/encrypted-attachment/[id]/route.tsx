...
import { genericDELETE, ***REMOVED***orizeDatabaseIdHash, genericGET } from "@/lib/generic-***REMOVED***";
...
export async function DELETE(request: Request, { params }: { params: { id: string }} ) {
    ...
    if(!recordLocator){
        ...
        const repo = new ServerEncryptedAttachmentRepository(await ***REMOVED***orizeDatabaseIdHash(request))
