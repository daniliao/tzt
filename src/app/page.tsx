...
import { PatientApiClient } from "@/data/client/patient-***REMOVED***-client";
  ...
  useEffect(() => {
    (async () => {
      const encryptionConfig: ApiEncryptionConfig = {
        ***REMOVED***Key: "SecretKeyTest", // TODO: for entities other than Config we should take the masterKey from server config
        useEncryption: true
      };
        ...
        <div className="p-6 flex flex-col">
          ...
          <div className="flex-1 overflow-auto">
            <div className="grid gap-6">
              <PatientRecords ***REMOVED***={0} patient={patients[0]} />
            </div>
          </div>
        </div>
      </div>
