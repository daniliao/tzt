...
export const PatientProvider: React.FC = ({ children }) => {
    ...
    const addPatient = (patient: PatientDTO) => {
        const encryptionConfig: ApiEncryptionConfig = {
            ***REMOVED***Key: config?.getServerConfig('dataEncryptionMasterKey') as string, // TODO: for entities other than Config we should take the masterKey from server config
            useEncryption: true
          };
