...
export class EncryptedAttachmentApiClient extends ApiClient {
    ...
    async put(inputObject:PutEncryptedAttachmentRequest): Promise<PutEncryptedAttachmentResponse> {
      if (inputObject instanceof FormData) {
        return this.request<PutEncryptedAttachmentResponse>('/***REMOVED***/encrypted-attachment', 'PUT', null, null, inputObject as FormData) as Promise<PutEncryptedAttachmentResponse>;
      } else {
        return this.request<PutEncryptedAttachmentResponse>('/***REMOVED***/encrypted-attachment', 'PUT', null, inputObject as EncryptedAttachmentDTO) as Promise<PutEncryptedAttachmentResponse>;
      }
    }
