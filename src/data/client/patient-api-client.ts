...
export class PatientApiClient extends ApiClient {
    ...
    async put(patient: PutPatientRequest): Promise<PutPatientResponse> {
      return this.request<PutPatientResponse>('/***REMOVED***/patient', 'PUT', PatientDTOEncSettings, patient) as Promise<PutPatientResponse>;
    }

    async delete(patient: PatientDTO): Promise<DeletePatientResponse> {
      return this.request<DeletePatientResponse>('/***REMOVED***/patient/' + patient.id, 'DELETE') as Promise<DeletePatientResponse>;
    }      
  }