...
export const prompts = {
    recordParseMultimodal: (context: PromptContext) => {
        return 'This is my health result data. Please parse it to JSON array of records including all findings, records, details, tests results, medications, diagnosis and others. \
                ...
                Summary the record to one nice sentence and put it under "title". Extract max 3 ***REMOVED***words (min 4 chars each) and put it in "tags" ***REMOVED*** including one tag equal to year of this record tags can not be personal data. \
